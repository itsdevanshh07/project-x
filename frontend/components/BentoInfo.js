                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {features.map((f, i) => (
                        <motion.div
                            ...
                            className={`${f.size} glass-card p-8 group cursor-default`}
                        >
                            ...
                            <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-secondary-action transition-colors">{f.title}</h3>
