                ...
                <div className="flex flex-col items-center text-center space-y-8 md:space-y-12">
                    ...
                    <div className="space-y-4 md:space-y-6 px-2 md:px-0">
                        <motion.h1
                            ...
                            className="text-step-4 md:text-7xl lg:text-8xl font-display font-bold text-white tracking-tighter leading-[1.1] md:leading-[1.05]"
                        >
                    ...
                    <motion.div
                        ...
                        className="flex flex-col sm:flex-row items-center gap-4 md:gap-6 w-full sm:w-auto px-6 sm:px-0"
                    >
                        <Magnetic strength={0.3} className="w-full sm:w-auto">
                            <Link href="/courses" className="btn-enroll group w-full sm:w-auto">
                                <span>Enroll Now</span>
                                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </Link>
                        </Magnetic>
                        <Magnetic strength={0.3} className="w-full sm:w-auto">
                            <Link href="/contact" className="btn-demo group w-full sm:w-auto">
                    ...
                    <motion.div
                        ...
                        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 pt-12 border-t border-white/5 w-full max-w-3xl"
                    >
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <span className="text-[10px] text-surface-light/40 uppercase tracking-widest">Top Tier Results</span>
                        </div>
                        <div className="flex flex-col items-center gap-2">
                            <ShieldCheck className="w-6 h-6 text-secondary-action" />
                            <span className="text-sm font-semibold text-white">Verified Trust</span>
                            <span className="text-[10px] text-surface-light/40 uppercase tracking-widest">Parent Approved</span>
                        </div>
                        <div className="flex flex-col items-center gap-2 sm:col-span-2 md:col-span-1">
                            ...
                            <span className="text-[10px] text-surface-light/40 uppercase tracking-widest">Personalized Growth</span>
                        </div>
                    </motion.div>
                </div>
            </div>
